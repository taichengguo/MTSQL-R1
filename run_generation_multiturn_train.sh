...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_FOLDER/train_sft_repeat20.parquet \
    ...
    trainer.experiment_name='qwen3_generation_text2sqlnew2' \
    ...
    trainer.save_rollout_only=True \
    trainer.rollout_data_dir="./rollouts_sql_1.7B/" \
    data.shuffle=False
